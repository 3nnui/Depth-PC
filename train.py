...
from depth_pc.models.graph_vs_depth import GraphVS
from depth_pc.sim.dataset_depth import DataLoader as DataLoaderDepth
from depth_pc.sim.dataset_depth_long import DataLoader as DataLoaderLong
from depth_pc.train_gvs_long_seq import TrainingPipeline as TrainLong
from depth_pc.train_gvs_long_seq import log_event, scheduler_lr
from depth_pc.train_gvs_short_seq import TrainingPipeline as TrainShort
from depth_pc.utils.trainer import Trainer


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--name", type=str, default="Depth-PC")
...
def train(args):
    ...
    data_class = DataLoaderLong if args.long else DataLoaderDepth
